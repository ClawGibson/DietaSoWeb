import { Form, Input, Button, Select, Row, Col, Card, Switch, message } from 'antd';
        ...
        try {
          ...
          const alimento = {
                    ...
                    "aspectoMedioambiental": {
                        ...
                        "huellaCarbono":  values.huellaCarbono , // EGEI
                    ...
                    "componentesBioactivos": {
                        ...
                        "resveratrol":  values.resveratrol ,
                ...
                <Row gutter={[8, 8]}>
                    <Col span={8}>
                        <Form.Item
                            ...
                            required>
                            <Input type="number" placeholder='Ingrese el factor de corrección para la huella hídrica YEGEI' />
                        </Form.Item>
                    </Col>
                    <Col span={8}>
                        <Form.Item
...
{/*
            ...
            */}
            ...
            <Form.Item>
                <Button type='primary' onClick={submitAli()} htmlType='submit' >
                    Submit
                </Button>
            </Form.Item>
        </Form>
