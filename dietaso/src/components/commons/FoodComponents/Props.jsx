    ...
    return(
        <>                        
            ...
            <div className="property">
                ...
                <input className="atr-editable" id="pClasE" placeholder="Inserte valor de la propiedad" required="true"/>                                                    
            </div>

            <div className="property">
                <h3 id="atr-titulo">Grupo de alimento</h3>
                <input className="atr-editable" id="pGroupAli" placeholder="Inserte valor de la propiedad"/>                                                    
            </div>
            ...
            <div className="property">
                ...
                <input className="atr-editable" id="sugerida" placeholder="Inserte valor de la propiedad"/>                                                     
            </div>
            ...
            <div className="property">
                ...
                <input className="atr-editable" id="fchh" placeholder="Inserte valor de la propiedad"/>                                                     
            </div>
            ...
            <div className="property">
                ...
                <input className="atr-editable" id="puntajeecologico" placeholder="Inserte valor de la propiedad"/>                                                     
            </div>
            ...
            <div className="property">
                <h4 id="sub">Precio</h4>
                <input className="atr-editable" id="precio" placeholder="Inserte valor de la propiedad"/>                                                     
            </div>  
            ...
            {/* TIMESTAMPS */}
            <div className="property">
                <h3 id="atr-titulo">Timestamps<hr/></h3>
            </div>
