...
const PropertiesComponent = ({item, getData, setShowAlimento, handleOk, showModal, isModalVisible, handleCancel, borrar}) => {  
    ...
    const establecerValores = () => {                
        if(item.nombreAlimento != null){
            ...
            /**  ASPECTO GLUCÉMICO  */
            document.getElementById("indiceglicemico").value = item?.aspectoGlucemico?.indiceGlicemico;
            document.getElementById("cargaglicemica").value = item?.aspectoGlucemico?.cargaGlicemica;
            /**  ASPECTO MEDIOAMBIENTAL  */
            document.getElementById("fchh").value = item?.aspectoMedioambiental?.factorDeCorreccionParaHuellaHidricaYEGEI;
            ...
            document.getElementById("hht").value = item?.aspectoMedioambiental?.huellaHidricaTotal;
            document.getElementById("hhv").value = item?.aspectoMedioambiental?.huellaHidricaVerde;
            document.getElementById("hha").value = item?.aspectoMedioambiental?.huellaHidricaAzul;
            document.getElementById("hhg").value = item?.aspectoMedioambiental?.huellaHidricaGris;
            ...
            document.getElementById("usosuelo").value = item?.aspectoMedioambiental?.usoDeSuelo;
            document.getElementById("nitrogeno").value = item?.aspectoMedioambiental?.nitrogeno;
            document.getElementById("fosforo2").value = item?.aspectoMedioambiental?.fosforo;
            document.getElementById("puntajeecologico").value = item?.aspectoMedioambiental?.puntajeEcologico;
            /**  ASPECTO ECONÓMICO  */
            document.getElementById("precio").value = item?.aspectoEconomico?.precio;
            document.getElementById("lugarcompra").value = item?.aspectoEconomico?.lugarDeCompra;
            document.getElementById("lugarventa").value = item?.aspectoEconomico?.lugarDeVenta;
            /**  COMPONENTES BIOACTIVOS */
            document.getElementById("fitoquimicos").value = item?.componentesBioactivos?.fitoquimicos;
            document.getElementById("polifenoles").value = item?.componentesBioactivos?.polifenoles;
            document.getElementById("antocianinas").value = item?.componentesBioactivos?.antocianinas;
            document.getElementById("taninos").value = item?.componentesBioactivos?.taninos;
            document.getElementById("isoflavonas").value = item?.componentesBioactivos?.isoflavonas;
            document.getElementById("reserveratrol").value = item?.componentesBioactivos?.resveratrol;
            document.getElementById("isotiocinatos").value = item?.componentesBioactivos?.isotiocinatos;
            document.getElementById("caretenoides").value = item?.componentesBioactivos?.caretenoides;
            document.getElementById("betacarotenos").value = item?.componentesBioactivos?.betacarotenos;
            ...
            document.getElementById("benzoatodesodio").value = item?.aditivosAlimentarios?.benzoatoDeSodio;
            document.getElementById("polisorbato").value = item?.aditivosAlimentarios?.polisorbato;
            document.getElementById("fcf").value = item?.aditivosAlimentarios?.azulBrillanteFCFoE133;
            document.getElementById("azorrubina").value = item?.aditivosAlimentarios?.azurrubinaOE102;
            document.getElementById("fdf").value = item?.aditivosAlimentarios?.amarilloOcasoFDFoE110;
            document.getElementById("tartrazina").value = item?.aditivosAlimentarios?.tartrazinaOE102;
            document.getElementById("e142").value = item?.aditivosAlimentarios?.verdeSoE142;
            document.getElementById("bn").value = item?.aditivosAlimentarios?.negroBrillanteBNoE151;
            document.getElementById("sucralosa").value = item?.aditivosAlimentarios?.sucralosa;
            ...
            document.getElementById("aspartame").value = item?.aditivosAlimentarios?.aspartame;
            document.getElementById("acesulfame").value = item?.aditivosAlimentarios?.acesulfameK;
    ...
    return (
        <>
            <div class="props">{/** CONTENEDOR PRINCIPAL FONDO BLANCO_GRISOSO */}           
                <div class="head_props">{/** DEFINE EL CONTENDOR DEL TITULO PROPIEDADES */}
