...
import { Col, Input, Space, Search, Image, Row, message  } from 'antd';
...
const Listas = () => {
    ...
    const onSearch = (target) => {
        console.log(target);
        setList(
            initialData.filter((ejercicios) =>
                ejercicios.nombre.includes(target)
    ...
    return (
        <div>
            <Row>
                ...
                <Col span={22}>
                <Space direction="vertical" style={{width:'90%', padding:20}}>
                    <Search  size="large" placeholder="Buscar por nombre" allowClear defaultValue={list} onSearch={onSearch} style={{ width: 1000 }}/>
